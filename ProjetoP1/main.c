...
int main( int argc, char *argv[])
{
    ...
    /*declarando os widgets que serão utilizados na aplicação*/
    GtkWidget *window;
    GtkWidget *fixed;
    GtkWidget *frame1;
    GtkWidget *button1;
    ...
    /*iniciando o GTK. esta função é essencial para qualquer aplicação GTK*/
    gtk_init(&argc, &argv);

    /*criando uma janela*/
    /*atribuindo titulo a janela*/
    /*conectando o sinal de destruição da janela*/
    ...
    /*criando um frame*/
    /*alinhando o label do frame a direita e no meio*/
    /*determinado o estilo do frame*/
    ...
    /*criando um estrutura fixed*/
    fixed = gtk_fixed_new();
    gtk_container_add(GTK_CONTAINER(frame1), fixed);

    /*criando os botões*/
    /*conectando-os a funções*/
    /*definindo sua posição fixa no plano window*/
    /*definindo seu tamanho fixo no plano window*/
    ...
    /*mostrando todos os widgets dentro de window*/
    gtk_widget_show_all(window);

    /*entrando no loop main*/
    gtk_main();
